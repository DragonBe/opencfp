...
final class ProcessAction
{
    ...
    private function getFormData(HttpFoundation\Request $request): array
    {
        return [
            ...
            'speaker_arrival_date' => $request->get('speaker_arrival_date'),
            'speaker_arrival_time' => $request->get('speaker_arrival_time'),
            'speaker_arrival_flight' => $request->get('speaker_arrival_flight'),
            'speaker_departure_date' => $request->get('speaker_departure_date'),
            'speaker_departure_time' => $request->get('speaker_departure_time'),
