...
final class EditAction
{
    ...
    public function __invoke(HttpFoundation\Request $request): HttpFoundation\Response
    {
        ...
        $content = $this->twig->render('user/edit.twig', [
            ...
            'speaker_arrival_date' => $speakerData['speaker_arrival_date'],
            'speaker_arrival_time' => $speakerData['speaker_arrival_time'],
            'speaker_arrival_flight' => $speakerData['speaker_arrival_flight'],
            'speaker_departure_date' => $speakerData['speaker_departure_date'],
